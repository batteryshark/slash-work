...
function compactDecision(decision) {
  return { id: decision.id, title: decision.title, detail: clip(decision.detail, 600), status: decision.status, options: decision.options, recommendedOption: decision.recommendedOption };
}
