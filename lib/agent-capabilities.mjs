...
const operations = [
  ...
  },
  {
    ...
    rules: ["Read the complete conversation before claiming or replying.", "The issue remains investigation-only authority even when it describes a desired code change.", "Image references like ../attachments/<record-id>/<name> are real files relative to the record in .work/; open them directly when local, or GET /api/attachments?record=<record-id>&name=<name>."],
  },
  {
    id: "issues.claim",
    category: "issues",
