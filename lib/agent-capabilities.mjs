...
const operations = [
  ...
  },
  {
    ...
    rules: ["Record only an action the human explicitly chose.", "Do not translate discussion or an open card into approval.", "For an option decision, approve with choice.option set to the exact recorded option; for a decision without options, put the human's written answer in note."],
